MtMoonB2F_Object:
	...
	object SPRITE_ROCKET, 11, 16, STAY, RIGHT, 2, OPP_ROCKET, 1
	object SPRITE_ROCKET, 19, 24, STAY, DOWN, 3, OPP_ROCKET, 2
	...
	; warp-to
	warp_to 27,  9, MT_MOON_B2F_WIDTH ; MT_MOON_B1F
