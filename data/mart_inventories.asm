...
; Pewter
PewterCashierText::
	TX_MART POKE_BALL, SUPER_POTION, SUPER_REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, TM_26

; Cerulean
CeruleanCashierText::
	TX_MART POKE_BALL, HYPER_POTION, SUPER_REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, TM_48
...
VermilionCashierText::
	TX_MART POKE_BALL, HYPER_POTION, ICE_HEAL, AWAKENING, PARLYZ_HEAL, SUPER_REPEL
